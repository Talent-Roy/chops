      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Signed up successfully! You can now log in.');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"../../node_modules/aos/dist/aos.js":[function(require,module,exports) {
var define;
...
_aos.default.init(); //DOM ELEMENTS
