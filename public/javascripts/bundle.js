      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: 'http://handymanng/api/v1/users/login',
              data: {
                email: email,
                password: password
              }
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'GET',
              url: 'http://handymanng/api/v1/users/logout'
            });
...
var logOutLg = document.querySelector('a.signout');
...
if (logOutLg) logOutLg.addEventListener('click', _login.logout);
