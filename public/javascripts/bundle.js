...
var showAlert = function showAlert(type, msg) {
  ...
  hideAlert();
  var markup = "<div class=\"alert alert--".concat(type, "\"><p>").concat(msg, "</p></div>");
...
exports.signout = exports.logout = exports.login = exports.signup = void 0;
...
var signup = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(name, email, password, confirmPassword, phoneNum) {
    var res;
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'Welcome to Choperholics, you are now logged in!');
    ...
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 3:
            res = _context4.sent;
            if (res.data.status = 'success') location.replace('/'); // console.log('route hit');
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              ...
              (0, _alert.showAlert)('success', "Thanks for reviewing this product");
              window.setTimeout(function () {
                location.reload();
              }, 1500);
            }
...
exports.cartRemoveOne = exports.cart = void 0;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "/api/v1/cart/add-to-cart/".concat(id)
            });
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              ...
              (0, _alert.showAlert)('success', "your order has been added to the cart!");
              window.setTimeout(function () {
                location.reload();
              }, 1000);
            }
...
var cartRemoveOne = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "/api/v1/cart/reduce-by-one/".concat(id)
            });
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              // console.log(res.data);
              (0, _alert.showAlert)('success', "you have removed this item from cart!");
              window.setTimeout(function () {
                location.reload();
              }, 1000);
            }
  ...
  return function cartRemoveOne(_x2) {
    return _ref2.apply(this, arguments);
  };
}();

exports.cartRemoveOne = cartRemoveOne;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            // console.log(data);
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', "Congrats! your product has been created.");
              window.setTimeout(function () {
...
var updateProduct = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(productId, name, category, price, quantity, priceDiscount, description, ratingsAverage, ratingsQuantity) {
    var id, res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', "Your update was successful.");
              window.setTimeout(function () {
                location.reload();
              }, 1500000);
            }
  ...
  return function updateProduct(_x, _x2, _x3, _x4, _x5, _x6, _x7, _x8, _x9) {
    return _ref.apply(this, arguments);
  };
}();
...
document.DOMContentLoaded = function () {
  document.getElementById('displayReviewForm').addEventListener('click', showReview);
}; // DOM ELEMENTS
...
var postReviewForm = document.querySelector('.post-review');
var postProductForm = document.querySelector('.post-product-form');
var updateProductForm = document.getElementById('updateProduct');
var addToCart = document.querySelectorAll('.add-to-cart');
var reduceByOne = document.querySelectorAll('.reduce-by-one');
/**
 * authenticaton ------------------------------------------------------
 */
...
if (signupForm) signupForm.addEventListener('submit', function (e) {
  ...
  (0, _login.signup)(name, email, password, confirmPassword, phoneNum);
});
...
if (signOutBtn) signOutBtn.addEventListener('click', _login.signout);
/**--------------------------------------------------------------------------------- */
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 7;
            return (0, _updateSettings.updateSettings)(currentPassword, password, confirmPassword, 'password');
...
if (postReviewForm) postReviewForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var productId = e.target.dataset.productId;
  var review = document.getElementById('review').value;
  var rating = document.getElementById('rating').value;
  (0, _review.postReview)(productId, review, rating);
});
/**------------------------------------------------------------------- */

/**products------------------------------------------------------------- */

if (postProductForm) postProductForm.addEventListener('submit', /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            form.append('images', document.getElementById('images').files[2]); // console.log(form);

            _context2.next = 13;
            return (0, _product.product)(form, 'data');
...
if (updateProductForm) updateProductForm.addEventListener('submit', /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(e) {
    var productId, name, category, price, quantity, priceDiscount, description, ratingsAverage, ratingsQuantity;
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            quantity = document.getElementById('updatedQuantity').value;
            priceDiscount = document.getElementById('updatedPriceDiscount').value;
            description = document.getElementById('updatedDescription').value;
            ratingsAverage = document.getElementById('updatedRatingsAverage').value;
            ratingsQuantity = document.getElementById('updatedRatingsQuantity').value;
            _context3.next = 12;
            return (0, _updateProduct.updateProduct)(productId, name, category, price, quantity, priceDiscount, description, ratingsAverage, ratingsQuantity);
...
if (addToCart) addToCart.forEach(function (el) {
  el.addEventListener('submit', function (e) {
    e.preventDefault();
    var productId = e.target.dataset.productId; // console.log(productId);

    (0, _cart.cart)(productId);
  });
});
if (reduceByOne) reduceByOne.forEach(function (el) {
  el.addEventListener('submit', function (e) {
    e.preventDefault();
    var productId = e.target.dataset.productId; // console.log(productId);

    (0, _cart.cartRemoveOne)(productId);
  });
});
/**------------------------------------------------------------------- */
...
function processCheckout(e) {
  ...
  var handler = PaystackPop.setup({
    ...
    onClose: function onClose() {
      (0, _alert.showAlert)('error', "Your order has been cancelled");
      window.setTimeout(function () {
        location.assign('/cart');
      }, 1500);
    },
    callback: function () {
      var _callback = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(response) {
        var userId, name, address, price, totalQty, itemNames, itemName, itemQtys, itemQty, itemPrices, itemPrice;
        return regeneratorRuntime.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                itemNames = document.querySelectorAll('.item-name');
                itemName = Array.from(itemNames).map(function (input) {
                  return input.value;
                });
                itemQtys = document.querySelectorAll('.item-qty');
                itemQty = Array.from(itemQtys).map(function (input) {
                  return input.value;
                });
                itemPrices = document.querySelectorAll('.item-price');
                itemPrice = Array.from(itemPrices).map(function (input) {
                  return input.value;
              ...
              case 14:
                ...
                if (response.status === 'success') {
                  (0, _alert.showAlert)('success', "Your order has been recieved, and is being processed you'll be contacted shortly");
                  window.setTimeout(function () {
